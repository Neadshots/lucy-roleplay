...
function showPlayerSelfMenu()
	...
	if getElementData(getLocalPlayer(), "realism:stretcher:hasStretcher") then
		...
		row.stretcher = exports['rightclick']:addRow("Sedyeyi bırak")
...
function showPlayerMenu(targetPlayer, friend)
	...
	if not friend then
		bAddAsFriend = exports['rightclick']:addRow("Arkadaş Ekle")
		addEventHandler("onClientGUIClick", bAddAsFriend, caddFriend, false)
	else
		bAddAsFriend = exports['rightclick']:addRow("Arkadaşlıktan çıkar")
		addEventHandler("onClientGUIClick", bAddAsFriend, cremoveFriend, false)
	end

	-- FRISK
	bFrisk = exports['rightclick']:addRow("Üstünü Ara")
	...
	if cuffed == 0 then
		...
		bRestrain = exports['rightclick']:addRow("Kelepçeyi çıkar")
	...
	if (blindfold) and (blindfold == 1) then
		bBlindfold = exports['rightclick']:addRow("Göz Bandını Çıkar")
		addEventHandler("onClientGUIClick", bBlindfold, cremoveBlindfold, false)
	else
		bBlindfold = exports['rightclick']:addRow("Göz Bandı")
