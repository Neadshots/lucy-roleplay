...
function createUniqueVehicle(data, existed)
	...
	if not existed then
		...
		exports.global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has created new unique vehicle #"..data.id..".")
		...
		exports.global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has updated unique vehicle #"..data.id..".")
		exports["vehicle"]:reloadVehicle(tonumber(data.id))
...
function resetUniqueVehicle(vehID)
	...
	exports.global:sendMessageToAdmins("[vehicle_manager]: "..getElementData(client, "account:username").." has removed unique vehicle #"..vehID..".")
	exports["vehicle"]:reloadVehicle(tonumber(vehID))
