...
function toggleDriveby()
	...
	if (getVehicleType(getPedOccupiedVehicle(localPlayer)) == "Automobile" and getElementData(getPedOccupiedVehicle(localPlayer), "vehicle:windowstat") == 0) or getVehicleType(getPedOccupiedVehicle(localPlayer)) == "BMX" then
	else
