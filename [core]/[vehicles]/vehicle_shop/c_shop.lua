...
GUIEditor = {
	...
	gui["_root"] = guiCreateWindow(0, 0, 349, 164, "Araç Satın Alma Ekranı - Lucy RPG v1", false)
	guiWindowSetSizable(gui["_root"], false)
	exports.global:centerWindow(gui["_root"])
	...
	gui["lblVehicleCost"] = guiCreateLabel(8, 74, 212, 44, "Araç Markası: "..getElementData(source, "brand").." "..getElementData(source, "maximemodel").." "..getElementData(source, "year").."\nAraç Fiyatı: $"..exports.global:formatMoney(carPrice), false, gui["_root"])
	...
	if exports.global:hasItem(localPlayer, 263, 1) and carPrice < 25000 then
...
function carshop_buyCar_click()
	if exports.global:hasSpaceForItem(getLocalPlayer(), 3, 1) then
		...
		outputChatBox(exports.pool:getServerSyntax(false, "s").."Envanterinizde bir anahtar için yer kalmadığı için satın alamıyorsunuz.", 255, 255, 255, true)
	end
