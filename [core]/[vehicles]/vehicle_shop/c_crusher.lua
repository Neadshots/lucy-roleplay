...
addEventHandler('crusher:show', root,
	function(price)
		...
		window = guiCreateWindow(left, top, windowWidth, windowHeight, "Crusher", false)
		guiCreateLabel(20, 15, windowWidth - 40, 16, 'We are about to crush your vehicle (permanently delete)!', false, window)
