g_items = {
	...
	[2] = { "Cep Telefonu", "iPhone, iletişim kurmanıza yarar.", 7, 330, 90, 90, 0, 0, weight = 0.3 },
	...
	[70] = { "First Aid Kit", "Saves a Life. Can be used #v times.", 4, 1240, 90, 0, 0, 0.05, weight = function(v)
	...
	[107] = { "Çakmak", "Ateş çıkarmaya yarıyan alet.", 6, 1210, 270, 0, 0, 0.1, weight = 0.05 }, -- 107
	...
	[112] = { "NASAR Üye Rozeti", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 }, -- 142
	...
	[116] = { "Mermi", "#v Merminiz bulunmakta.", 9, 2040, 0, 1, 0, 0.1, 3, weight = function( v ) local weaponID = tonumber( explode(":", v)[1] ) local ammo = tonumber( explode(":", v)[2] ) return weaponID and ammo and ammoweights[ weaponID ] and ammoweights[ weaponID ] * ammo or 0.2 end }, -- 2886 / 116
	...
	[128] = { "Rapid Towing", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 }, --128 --MAXIME | ADD TTR FACTION BAGDE ITEM | 24.1.14
	...
	[134] = { "Para", "Los Santos para birimi.", 10, 1212, 0, 0, 0, 0.04, weight = 0.3 }, -- 134
	...
	[152] = { "Los Santos Kimlik Kartı", "Kişisel Bilgilerinizin Bulunduğu Kart.", 10, 1581, 270, 270, 0, 0, weight = 0.1 }, -- PEDROLANGES
	...
	[215] = { "ASGH Badge", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 },
	[216] = { "FBI Badge", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 },
	...
	[261] = { "Kılıç Balığı", "Denizde bulunan bir balik cesiti", 6, 1271, 0, 0, 0, 0.285, weight = 0.2, preventSpawn = true },
	...
	[285] = { "Pizza Kutusu", "#v Dilim Pizza .", 6, 3044 , 270, 0, 0, 0.1, weight = function(v) return 0.5 + v*0.5 end }, -- 285
...
function getBadges( )
	return {
		...
		[64]  = { "LSPD badge", 		"LSPD badgesi",			{[1] = true},				 	{65,65,255, true},	2},
		[216]  = { "FBI badge", 		"FBI Badgesi",			{[148] = true},				 	{6,158,120, true},	2},
		[215]  = { "ASGH badge", 		"a ASGH badge",			{[2] = true},				 	{155, 89, 182, true},	2},
		[112]  = { "NASAR badge", 		"a NASAR badge",			{[194] = true},				 	{165, 150, 0, true},	2}, -- Sheriff department
		[65]  = { "LSFD badge", 		"a LSFD badge", {[2213123] = true},	    {175,50,50},	1},
		[86]  = { "LSN badge",		"an LSN ID",				{[20] = true},					{250,125,0},	1},
		...
		[127] = { "FAA badge",		"a FAA badge",	{[47] = true},	{255,140,0},	2},
		[82] = { "Rapid Towing", "An ID from Rapid Towing",	{[4] = true},	{0,255,0},	1}, --MAXIME | ADD TTR FACTION BAGDE ITEM | 24.1.14
		...
		-- [129] = { "Direct Imports ID",		"a Direct Imports ID",	{[7] = true},	{88, 130, 250},	1},
			 [131] = { "LSCSD badge",        "an LSCSD badge",                {[59] = true},                    {210, 180, 140},    1}, -- Adams added the LSCSD badge / 03/02/14
...
for k, v in pairs(getBadges()) do
	if not v[3][-1] and g_items[k][3] ~= 10 then
		outputDebugString('Badge/ID' .. k .. ' badge bir para değildir.')
	end
end
...
function getMasks( )
	return {
		...
		[90]  = {"helmet",			"kask'ı kafasına geçirir.",				"kask'ı kafasından çıkartır",				false},
