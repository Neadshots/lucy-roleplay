...
function publicSellProperty(thePlayer, dbid, showmessages, givemoney, CLEANUP)
	...
	if query then
		...
		if interiorType == 0 or interiorType == 1 then
			...
			local gov = getTeamFromName("İstanbul Büyük Şehir Belediyesi")
			...
			if interiorStatus[INTERIOR_OWNER] == getElementData(thePlayer, "dbid") then
				...
				if showmessages then
					if CLEANUP == "FORCESELL" then
						...
						outputChatBox("Mülkünüzü sattınız " .. exports.global:formatMoney(money) .. exports.pool:getServerMoneyType(thePlayer).."", thePlayer, 0, 255, 0)
					end
				end
			...
			elseif interiorStatus[INTERIOR_FACTION] == getElementData(thePlayer, "faction") then
				...
				if showmessages then
					if CLEANUP == "FORCESELL" then
						exports.global:sendMessageToAdmins("[INTERIOR]: "..exports.global:getPlayerFullIdentity(thePlayer).." has force-sold interior #"..dbid.." ("..getElementData(interiorElement,"name")..").") 
					elseif faction then
						outputChatBox("Mülkünüzü sattınız " .. exports.global:formatMoney(money) .. exports.pool:getServerMoneyType(thePlayer).." (Bankaya havale yapıldı: '"..getTeamName(faction).."')", thePlayer, 0, 255, 0)
					end
				end
...
function buyInterior(player, pickup, cost, isHouse, isRentable, isFurniture)
	...
	if exports.global:takeMoney(player, cost) then
		if (isHouse) then
			outputChatBox("Tebrikler! Az önce bu evi satın aldınız "..exports.pool:getServerMoneyType(thePlayer) .. exports.global:formatMoney(cost) .. ".", player, 255, 194, 14)
			exports.global:giveMoney( getTeamFromName("İstanbul Büyük Şehir Belediyesi"), cost )
		elseif (isRentable) then
			outputChatBox("Tebrikler! Az önce bu evi kiraladınız "..exports.pool:getServerMoneyType(thePlayer) .. exports.global:formatMoney(cost) .. ".", player, 255, 194, 14)
		else
			outputChatBox("Tebrikler! Az önce bu işyerini aldınız "..exports.pool:getServerMoneyType(thePlayer) .. exports.global:formatMoney(cost) .. ".", player, 255, 194, 14)
			exports.global:giveMoney( getTeamFromName("İstanbul Büyük Şehir Belediyesi"), cost )
		end
		...
		exports["interior-manager"]:addInteriorLogs(pickupid, "Alındı ​​/ Kiralandı, "..exports.pool:getServerMoneyType(thePlayer) ..exports.global:formatMoney(cost)..", "..getPlayerName(thePlayer), thePlayer)
	else
...
function buypropertyForFaction(interior, cost, isHouse) --Maxime
	...
	exports.bank:addBankTransactionLog(-factionId, -(getElementData(gov, "id")), cost, 3 , "Mülk Satın Alma", intName.." (ID: "..intId..")" )
	...
	outputChatBox("Tebrikler! Bu mülkü az önce satın aldınız '"..factionName.."' "..exports.pool:getServerMoneyType(thePlayer) .. exports.global:formatMoney(cost) .. ".", source, 255, 194, 14)
	...
	exports["interior-manager"]:addInteriorLogs(intId, "'"..factionName.."', "..exports.pool:getServerMoneyType(thePlayer) ..exports.global:formatMoney(cost)..", "..getPlayerName(source), source)
...
function buyInteriorCash(player, pickup, cost, isHouse, isRentable, isFurniture)
	...
	if exports.global:takeMoney(player, cost) then
		...
		elseif (isRentable) then
			outputChatBox("Tebrikler! Az önce bu mülkü kiraladınız "..exports.pool:getServerMoneyType(thePlayer) .. exports.global:formatMoney(cost) .. ".", player, 255, 194, 14)
		else
			outputChatBox("Tebrikler! Az önce bu işyerini satın aldınız "..exports.pool:getServerMoneyType(thePlayer) .. exports.global:formatMoney(cost) .. ".", player, 255, 194, 14)
		end
		...
		realReloadInterior(tonumber(pickupid), {player})
		exports["interior-manager"]:addInteriorLogs(pickupid, "Alındı ​​/ Kiralandı, "..exports.pool:getServerMoneyType(thePlayer) ..exports.global:formatMoney(cost)..", "..getPlayerName(player), player)
...
function buyInteriorBank(player, pickup, cost, isHouse, isRentable)
	...
	if not exports.bank:takeBankMoney(player, cost) then
		...
		exports.bank:addBankTransactionLog(charid, -(getElementData(gov, "id")), cost, 2 , "Mülk Satın Alma", intName.." (ID: "..pickupid..")" )
