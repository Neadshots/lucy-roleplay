...
interiors = { 	
	...
	[158] = { 0, 1527.72265625, 1616.08203125, 15.43788433075 , 180 , "RS Haul Warehouse (Maxime)"  }, -- 158 
	...
	[180] = { 0,222.05859375, 157.328125, 1014.151550293,0,"SARP INT#Akademi"}, --Jesse
} 
...
function printInteriorsList(thePlayer, commandName,  from, to )
	...
	local count = 0
	local linkForum = "http://owlgaming.net/?page_id=112"
