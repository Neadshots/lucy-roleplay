function vehicleBlown()
	setElementData(source, "lspd:siren", false)
...
function setSirenState(type)
	if exports.global:hasItem(source, 85) then -- sirens
		...
		setElementData(source, "lspd:siren", id)
		
		setVehicleSirensOn(source , type == false and false or true )
	end
end
    ...
    if player and (seat==0) then
		if exports.global:hasItem(source, 85) then -- sirens
			...
			elseif ( getVehicleName(source) == "Premier" ) then
				addVehicleSirens(source,5,2, false, true, true, true)
				--vehicle, sirenPoint, x, y, z, r, g, b, alpha, minAlpha
				setVehicleSirens(source, 1, -0.3, -1.9, 0.4, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 2, 0.3, -1.9, 0.4, 0, 0, 255, 255, 255)
				setVehicleSirens(source, 3, 0.0, -2.9, -0.1, 255, 215, 0, 100, 100)
				setVehicleSirens(source, 4, -0.3, 2.7, 0.0, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 5, 0.3, 2.7, 0.0, 0, 0, 255, 255, 255)
			elseif ( getVehicleName(source) == "Patriot" ) then
				addVehicleSirens(source,4,2, false, true, true, true)
				--vehicle, sirenPoint, x, y, z, r, g, b, alpha, minAlpha
				setVehicleSirens(source, 1, -0.3, -1.7, 0.4, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 2, 0.3, -1.7, 0.4, 0, 0, 255, 255, 255)
				setVehicleSirens(source, 3, -0.3, 2.5, 0.0, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 4, 0.3, 2.5, 0.0, 0, 0, 255, 255, 255)
			elseif ( getVehicleName(source) == "Huntley" ) then
				addVehicleSirens(source,4,2, false, true, true, true)
				--vehicle, sirenPoint, x, y, z, r, g, b, alpha, minAlpha
				setVehicleSirens(source, 1, -0.3, -3, 0.4, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 2, 0.3, -3, 0.4, 0, 0, 255, 255, 255)
				setVehicleSirens(source, 3, -0.3, 2.6, 0.0, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 4, 0.3, 2.6, 0.0, 0, 0, 255, 255, 255)
			elseif ( getVehicleName(source) == "Sultan" ) then
				addVehicleSirens(source,4,2, false, true, true, true)
				--vehicle, sirenPoint, x, y, z, r, g, b, alpha, minAlpha
				setVehicleSirens(source, 1, -0.3, -1.7, 0.4, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 2, 0.3, -1.7, 0.4, 0, 0, 255, 255, 255)
				setVehicleSirens(source, 3, -0.3, 2.7, 0.0, 255, 0, 0, 255, 255)
				setVehicleSirens(source, 4, 0.3, 2.7, 0.0, 0, 0, 255, 255, 255)
