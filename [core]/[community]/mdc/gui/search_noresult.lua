...
function search_noresult ( )
	...
	window.window = guiCreateWindow( x, y, width, height, "MDC Arama - Sonuc Yok!", false )
	
	window.errorLabel = guiCreateLabel( 10, 30, width - 20, 20, "Bunun icin hicbir eslesme bulamadik!", false, window.window )
