...
function addImage(url, data)
	if source then -- Triggered from server.
		...
		if size and size>0 then
			outputDebugString("[CACHE] Images / Client / addImage / Received "..exports.global:formatMoney(math.floor(size/1000)).."KB of data from server. Cached image in client's file system as '"..filename.."' - "..url)
