...
function drawnCharacters()
	...
	dxDrawText("www.lucyrpg.com adresinden karakter başvurusu oluşturun.", x, y+newCharacter_array, w+x, y+h+newCharacter_array, tocolor(255, 255, 255), 1, font2, 'center', 'center')
...
function Exclusive.createGUI()
	...
	if (button == "left") then 
		...
		creationSteps['language'] = exports['language-system']:getLanguageName(row + 1)
