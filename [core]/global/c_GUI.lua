...
function getIcon(icon)
    if type(icon) == "string" then
        if iconCache["fa-" .. icon] then
            return iconCache["fa-" .. icon] 
        elseif iconCache[icon] then
...
local fontsSource = {
    --["fontName"] = "source"
	["MyriadPro-Regular"] = "files/fonts/MyriadPro-Regular.otf",
	["gotham_light"] = "files/fonts/gotham_light.ttf",
	["Roboto"] = "files/fonts/Roboto.ttf", 
    ["AwesomeFont"] = "files/fonts/FontAwesome.otf",
    ["LoginFont"] = "files/fonts/loginfont.ttf",
}
...
function getFont(font, size)
    ...
    if not fontE then
        outputDebugString("Font:" ..font.. " Size.."..size.." want to getted but not created in fontcache! [Details: Returned false value]")
    end
