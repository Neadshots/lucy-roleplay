...
function showAdminJailCounter()
	...
	if jailtime and (tonumber(jailtime) and tonumber(jailtime) > 0) or jailtime == "permanently" then
	    ...
	    dxDrawText("Admin cezası", 630-xo, 38-yo, 872-xo, 76-yo, tocolor(255, 255, 255, 255), 1.00, "pricedown", "center", "center", false, false, true, false, false)
	    dxDrawText("Sebep: "..(getElementData(localPlayer, "jailreason") or "Bilinmiyor"), 553-xo, 100-yo, 945-xo, 127-yo, tocolor(255, 255, 255, 255), 1.00, "default", "center", "center", false, true, true, false, false)
	    ...
	    dxDrawText("Admin tarafından cezalandırıldı: "..(getElementData(localPlayer, "jailadmin") or "Bilinmiyor"), 553-xo, 117-yo, 945-xo, 144-yo, tocolor(255, 255, 255, 255), 1.00, "default", "center", "bottom", false, true, true, false, false)
	else
