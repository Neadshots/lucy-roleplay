				...
				elseif (logged==1) then
					...
					if getElementData(targetPlayer, "license."..licenseType) == 1 then
						...
						if (licenseType == "car") then -- DRIVERS LICENSE
							setElementData(targetPlayer, "license."..licenseType, 1, false)
						...
						elseif (licenseType == "pilot.rot") then -- Pilot ROT (helicopters)
							setElementData(targetPlayer, "license.pilot", 1, false)
							dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='1' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
						...
						elseif (licenseType == "pilot.ser") then -- Pilot SER (small planes)
							setElementData(targetPlayer, "license.pilot", 2, false)
							dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='2' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
						...
						elseif (licenseType == "pilot.rot-ser") then -- Pilot ROT+SER (helicopters and small planes)
							setElementData(targetPlayer, "license.pilot", 3, false)
							dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='3' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
						...
						elseif (licenseType == "pilot.mer") then -- Pilot MER (medium planes)
							setElementData(targetPlayer, "license.pilot", 4, false)
							dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='4' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
						...
						elseif (licenseType == "pilot.ter") then -- Pilot TER (big planes)
							setElementData(targetPlayer, "license.pilot", 5, false)
							dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='5' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
						...
						elseif (licenseType == "pilot.rot-mer") then -- Pilot ROT+MER (helicopters and medium planes)
							setElementData(targetPlayer, "license.pilot", 6, false)
							dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='6' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
						...
						elseif (licenseType == "pilot.rot-ter") then -- Pilot ROT+TER (helicopters and big planes)
							setElementData(targetPlayer, "license.pilot", 7, false)
							dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='7' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
...
function issuePilotCertificate(thePlayer, commandName, targetPlayer, pilotLevel)
	if (getElementData(thePlayer, "faction") == 47 and getElementData(thePlayer, "factionleader") == 1) or exports.integration:isPlayerSeniorAdmin(thePlayer) then
			...
			if targetPlayer then -- is the player online?
				...
				if (logged==0) then -- Are they logged in?
					...
					if(pilotLevel > 0) then
						...
						setElementData(targetPlayer, "license.pilot", pilotLevel, false)
						dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='"..pilotLevel.."' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
					...
					elseif(pilotLevel == 0) then
						...
						setElementData(targetPlayer, "license.pilot", 0, false)
						dbExec(mysql:getConnection(), "UPDATE characters SET pilot_license='0' WHERE id = "..(getElementData(targetPlayer, "dbid")).." LIMIT 1")
					end
				end
			else
...
function getOldPilotLicense(thePlayer, commandName, targetPlayer)
	...
	local targetPlayer, targetPlayerName = exports.global:findPlayerByPartialNick(thePlayer, targetPlayer)
	if targetPlayer then
		if (getElementData(thePlayer, "faction") == 47 and getElementData(thePlayer, "factionleader") == 1) or exports.integration:isPlayerTrialAdmin(thePlayer) or (targetPlayer == thePlayer) then
