...
local gui = {}
local data = {}
local moon = "1" -- do not change the moon
...
function openLocationManager(locationData)
    ...
    gui.manager = guiCreateWindow(0, 0, w, h, "Teleport Locations Manager v"..moon.."", false)
    ...
    for v, k in pairs(data) do
        ...
        guiGridListSetItemText(a, b, gui.colCreator, k["location_creator"], false, false)
    end
