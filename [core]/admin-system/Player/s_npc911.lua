...
function doTheCall(thePlayer, message, location)
	...
	local query = dbExec(exports.mysql:getConnection(), "INSERT INTO `mdc_calls` (`caller`,`number`,`description`) VALUES ('Unknown Person','"..outboundPhoneNumber.."','"..(tostring(location) .. " - " .. message ).."')")
