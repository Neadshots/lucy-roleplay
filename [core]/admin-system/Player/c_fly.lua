function canFly()
  return (exports.integration:isPlayerTrialAdmin(localPlayer) or (exports.global:isPlayerScripter(localPlayer)) or getElementData(localPlayer, "canFly")) and not getElementData(localPlayer, "parachuting")  and not getElementData(localPlayer, "parachuting") 
end
