...
function editStaff(userid, ranks, details)
	...
	if ranks[1] and ranks[1] ~= tonumber(user.admin) then
		...
		exports.global:sendMessageToStaff("[Yetki Güncellemesi] "..exports.global:getPlayerFullIdentity(source, 1, true).." adlı yetkili "..(ranks[1] > tonumber(user.admin) and "promoted" or "demoted").." '"..user.username.."' from "..staffTitles[1][tonumber(user.admin)].." to "..staffTitles[1][ranks[1]]..".", true)
	...
	if ranks[2] and ranks[2] ~= tonumber(user.supporter) then
		...
		exports.global:sendMessageToStaff("[Yetki Güncellemesi] "..exports.global:getPlayerFullIdentity(source, 1, true).." adlı yetkili "..(ranks[2] > tonumber(user.supporter) and "promoted" or "demoted").." '"..user.username.."' from "..staffTitles[2][tonumber(user.supporter)].." to "..staffTitles[2][ranks[2]]..".", true)
	...
	if ranks[3] and ranks[3] ~= tonumber(user.vct) then
		...
		exports.global:sendMessageToStaff("[Yetki Güncellemesi] "..exports.global:getPlayerFullIdentity(source, 1, true).." adlı yetkili "..(ranks[3] > tonumber(user.vct) and "promoted" or "demoted").." '"..user.username.."' from "..staffTitles[3][tonumber(user.vct)].." to "..staffTitles[3][ranks[3]]..".", true)
	...
	if ranks[4] and ranks[4] ~= tonumber(user.scripter) then
		...
		exports.global:sendMessageToStaff("[Yetki Güncellemesi] "..exports.global:getPlayerFullIdentity(source, 1, true).." adlı yetkili "..(ranks[4] > tonumber(user.scripter) and "promoted" or "demoted").." '"..user.username.."' from "..staffTitles[4][tonumber(user.scripter)].." to "..staffTitles[4][ranks[4]]..".", true)
	...
	if ranks[5] and ranks[5] ~= tonumber(user.mapper) then
		...
		exports.global:sendMessageToStaff("[Yetki Güncellemesi] "..exports.global:getPlayerFullIdentity(source, 1, true).." adlı yetkili "..(ranks[5] > tonumber(user.mapper) and "promoted" or "demoted").." '"..user.username.."' from "..staffTitles[5][tonumber(user.mapper)].." to "..staffTitles[5][ranks[5]]..".", true)
