...
local screenW, screenH = guiGetScreenSize()
    ...
    function paneldx ()
	if (getElementData(getLocalPlayer(), "tamirci" ) == 2) then
	if acikmi then
...
if exports.colorblender:isPickerOpened("renk1") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk2") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk3") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk4") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
    exports.colorblender:openPicker("renk1", string.format("#%02X%02X%02X", 0, 0, 0) , "Renk - 1")
elseif mouse(screenW * 0.8328, screenH * 0.4433, screenW * 0.1594, screenH * 0.0433) then -- renk 2  exports.colorblender:openPicker("renk2", string.format("#%02X%02X%02X", 0, 0, 0) , "Renk - 2")
if exports.colorblender:isPickerOpened("renk1") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk2") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk3") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk4") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
  exports.colorblender:openPicker("renk2", string.format("#%02X%02X%02X", 0, 0, 0) , "Renk - 2")
elseif mouse(screenW * 0.8328, screenH * 0.5133, screenW * 0.1594, screenH * 0.0433) then -- renk 3
if exports.colorblender:isPickerOpened("renk1") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk2") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk3") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk4") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
    exports.colorblender:openPicker("renk3", string.format("#%02X%02X%02X", 0, 0, 0) , "Far Rengi")	
elseif mouse(screenW * 0.8328, screenH * 0.5833, screenW * 0.1594, screenH * 0.0433) then -- renk 4
if exports.colorblender:isPickerOpened("renk1") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk2") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk3") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
if exports.colorblender:isPickerOpened("renk4") then outputChatBox("Zaten bir pencere açık.", 255, 0 ,0) return end
    exports.colorblender:openPicker("renk4", string.format("#%02X%02X%02X", 0, 0, 0) , "Renk - 4")	
...
if (getElementData(getLocalPlayer(), "tamirci" ) == 2) then
    ...
    if renk == 'renk2' then
		...
		if  (exports.global:takeMoney(getLocalPlayer(),2000)) then
