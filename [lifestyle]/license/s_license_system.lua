...
function recoveryLicense(licensetext, cost, itemID, npcName)
	if not exports.global:takeMoney(source, cost) then
		exports.hud:sendBottomNotification(source, npcName, "Can I have $"..exports.global:formatMoney(cost).." fee for recovering the "..licensetext.." please?")
		return false
	end

	if exports.global:giveItem(source, itemID, getPlayerName(source):gsub("_", " ")) then
		exports.hud:sendBottomNotification(source, npcName, "You have paid $"..exports.global:formatMoney(cost).." fee for recovering the "..licensetext..".")
	end
end
...
function onLicenseServer()
	...
	if (gender == 0) then
		exports.global:sendLocalText(source, "Carla Cooper diyor ki: Merhaba beyefendi, ehliyet için mi başvuracaktınız?", 255, 255, 255, 10)
	else
		exports.global:sendLocalText(source, "Carla Cooper diyor ki: Merhaba hanfendi, ehliyet için mi başvuracaktınız?", 255, 255, 255, 10)
	end
end
...
function payFee(amount, reason)
	if exports.global:takeMoney(source, amount) then
		...
		exports.hud:sendBottomNotification(source, "Motorlu Taşıtlar Departmanı", reason.." için $"..exports.global:formatMoney(amount).." ödediniz.")
	end
end
