...
local atmPed = createPed( 113, 359.7138671875, 173.8740234375, 1008.3893432617 )
setPedRotation( atmPed, 270)
setElementDimension( atmPed, 2)
setElementInterior( atmPed , 3)
...
--GENERAL SERVICE PED
local localPlayer = getLocalPlayer()
local generalServicePed = createPed( 290, 356.294921875, 168.8955078125, 1008.3762207031)
setPedRotation( generalServicePed, 270)
setElementDimension( generalServicePed, 1)
setElementInterior( generalServicePed , 3)
