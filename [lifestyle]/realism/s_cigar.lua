...
function Bind1(thePlayer)
    ...
    if (sigara) then
       exports.global:applyAnimation(thePlayer, "SMOKING", "M_smkstnd_loop", 6000, false, true, true)
       triggerEvent("realism:startsmoking", thePlayer, 0)
       setTimer ( function()
        exports.bone_attach:attachElementToBone(duman,thePlayer,1,0,0,0,0,266,0)
        end, 5000, 1 )
       setTimer ( function()
        exports.bone_attach:detachElementFromBone(duman) 
...
function Bind2(thePlayer)
    ...
    duman = createObject(2012,0,0,0) 
    if (sigara) then
       exports.global:applyAnimation(thePlayer, "GANGS", "smkcig_prtl", 8000, false, true, true)
...
function stopSmokingCMD(thePlayer)
    ...
    if (isSmoking) then
        ...
        exports.global:sendLocalMeAction(thePlayer, "sağ elindeki sigarayı yere atar.")
    end
end
