...
function changeDeathView(source, victimDropItem, isSuicide)
	if isPedDead(source) then
		...
		--setElementData(source, "dead", 1) -- Geri Açılabilir
		--setElementData(source, "es-system:Baygin", 1) -- Gereksizlik Gerekçesiyle Kaldırıldı! ( pavlov )
		spawnPlayer(source, x, y, z, 0, skin, int, dim, team)
		--exports.global:applyAnimation( source, "ped", "FLOOR_hit_f", -1, false, false, true)
		--setPedAnimation( source, "ped", "KO_skid_front", -1, false, false, false) -- FLOOR_hit_f
		--toggleAllControls ( source, true, false )
...
function respawnPlayer(thePlayer, victimDropItem)
	if (isElement(thePlayer)) then
		...
		exports.global:giveMoney( getTeamFromName("Los Santos Acil Servisleri"), math.ceil((1-tax)*cost) )
		exports.global:takeMoney( getTeamFromName("Los Santos Hükümeti"), math.ceil((1-tax)*cost) )
