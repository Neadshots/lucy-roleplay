...
196, 197, 198, 199, 201, 205, 214, 216, 224, 225, 226, 231, 232, 233, 237, 243, 246, 251, 263 }
...
g_shops = {
	{ -- 1
...

		{
			...
			{ name = "Baseball Bat", description = "Beyzbol Sopası", price = 60, itemID = 115, itemValue = 5 },
	...
	{ -- 8
...

		{
			...
			{ name = "Safe", description = "A Safe to store your items in.", price = 500, itemID = 60 },
	...
	{ -- 20 ( Pet Shop )
		...
		{
			name  = "Disgusting Stuff",
			{ name = "Su", description = "", price = 5, itemID = 15 },
			{ name = "Köpek Maması", description = "", price = 20, itemID = 279 },
		}
	},
	{
		name = "Spor Mağazası",
		...
		{
			name = "Spor Aletleri",
			{ name = "Golf Club", description = "Golf Sopası", price = 60, itemID = 115, itemValue = 2 },
			{ name = "Baseball Bat", description = "Beyzbol Sopası", price = 60, itemID = 115, itemValue = 5 },
			{ name = "Mask", description = "Maske", price = 20, itemID = 56 },
