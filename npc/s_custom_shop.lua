...
function storeKeeperSay(thePlayer, content, pedName)
    ...
    exports.global:sendLocalText(thePlayer, " "..tostring(pedName).." says: "..content, 255, 255, 255, 30, {}, true)
end
        ...
        for _, owner in ipairs(possibleOwners) do
            ...
            if isBizOwner then 
                if exports.global:hasItem(owner, 2) then 
                    ...
                    outputChatBox(" SMS from "..pedName.." at "..bizName..": "..content, owner, 120, 255, 80)
