...
function showCreateFactionDropItem(npcID)
	...
	gui.lItem = guiCreateLabel(43,39,117,24,"Silah:",false,gui.main)
	guiLabelSetVerticalAlign(gui.lItem,"center")
	guiSetFont(gui.lItem,"default-bold-small")

	gui.cItem = guiCreateComboBox(170,39,213,24,"Yok",false,gui.main)
	local comboItemIndex = {}
	comboItemIndex[0] = {nil, nil, "Yok"}
	guiComboBoxAddItem(gui.cItem, "Yok")
	...
	gui.lCaliber = guiCreateLabel(43,73,117,24,"Kalibre:",false,gui.main)
	...
	gui.lItemDesc = guiCreateLabel(43,107,117,24,"Özel isim:",false,gui.main)
	...
	local xOffset1 = 70
	gui.lPrice = guiCreateLabel(43,141,117,24,"Fiyat:",false,gui.main)
	...
	local xOffset2 = 203
	gui.lQuan = guiCreateLabel(43+xOffset2,141,117,24,"Miktar:",false,gui.main)
	...
	gui.lRetock = guiCreateLabel(43,175,117,24,"Otomatik-Yeniden Stoklama:",false,gui.main)
	...
	gui.bCancel = guiCreateButton(33,239,187,37,"Kapat",false,gui.main)
	guiSetFont(gui.bCancel,"default-bold-small")
	addEventHandler( "onClientGUIClick", gui.bCancel,function()
		closeCreateFactionDropItem()
	end, false )

	gui.bCreate = guiCreateButton(220,239,191,37,"Yarat",false,gui.main)
	...
	addEventHandler( "onClientGUIClick", gui.bCreate,function()
		if gui.main and isElement(gui.main) then
			...
			guiSetText(gui.bCreate, "Sunucuya istek gönderiliyor..")
		end
...
function factionDropWeaponBuy(products, proID, shopElement)
	...
	wfactionDropWeaponBuy = guiCreateWindow( X, Y, Width, Height,"Ürün satın alma",false)
	exports.global:playSoundSuccess()
	local itemURL = nil

	if tonumber(item["pItemID"]) == 115 then -- weapons
		itemURL = ":item-system/images/-"..string.match(tostring(item["pItemValue"]), "(%d+)")..".png"
	else -- ammo
		itemURL = ":item-system/images/116.png"
	end
	...
	local lProductName = guiCreateLabel(147,27,280,18,"Ürün ismi: "..itemName or ""..".",false,wfactionDropWeaponBuy)
	local lAmount = guiCreateLabel(147,45,280,18,"Detaylar: "..itemValue or ""..".",false,wfactionDropWeaponBuy)
	local lPrice = guiCreateLabel(147,63,42,18,"Fiyat: $",false,wfactionDropWeaponBuy)
	local ePrice = guiCreateLabel(189,62,238,20,exports.global:formatMoney(itemPrice),false,wfactionDropWeaponBuy)
	local lDesc = guiCreateLabel(147,81,250,18,"Bu ürünü satın alma sebebi: ",false,wfactionDropWeaponBuy)
	...
	bRemove = guiCreateButton(9,161,142,27,"Çıkar",false,wfactionDropWeaponBuy)
	...
	if canPlayerAdminShop(localPlayer) then
		addEventHandler( "onClientGUIClick", bRemove, function ()
			...
			guiSetText(bRemove, "İtem çıkarılıyor..")
	...
	local bPayByCash = guiCreateButton(151,161,142,27,"Nakit ödeme",false,wfactionDropWeaponBuy)
	...
	local bCancel = guiCreateButton(291,161,136,27,"Kapat",false,wfactionDropWeaponBuy)
