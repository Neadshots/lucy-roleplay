...
function updateContactDetails(id, name, number, email, address, favo)
	...
	if dbExec(mysql:getConnection(),"UPDATE `phone_contacts` SET `entryName`='"..exports.global:toSQL(name).."', `entryNumber`='"..exports.global:toSQL(number).."', `entryEmail`='"..exports.global:toSQL(email).."', `entryAddress`='"..exports.global:toSQL(address).."', `entryFavorited`='"..exports.global:toSQL(favo).."' WHERE `id`='"..exports.global:toSQL(id).."' ") then
...
function deleteContact(id)
	...
	if dbExec(mysql:getConnection(),"DELETE FROM `phone_contacts` WHERE `id`='"..exports.global:toSQL(id).."' ") then
