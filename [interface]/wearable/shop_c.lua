...
local preview = exports["object-preview"]
...
local shopPed = createPed(240, 206.5087890625, -162.978515625, 1000.5234375);
setElementRotation(shopPed, 0, 0, 94)
shopPed:setData("name", "Albertino_Nicholson")
shopPed:setData("nametag", true)
shopPed.frozen = true
shopPed.dimension = 48
shopPed.interior = 14
setPedAnimation(shopPed, "COP_AMBIENT", "Coplook_loop", -1, true, false, false)
...
addEventHandler("onClientRender", root,
	function()
		...
		dxDrawText("Aksesuar Mağazası - LUCY RPG v3", x, y, w+x, 25+y, tocolor(255, 255, 255), 1, font, "center", "center")
