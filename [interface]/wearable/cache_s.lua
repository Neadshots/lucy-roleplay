...
addEventHandler("wearable.delete", root,
    function(player, dbid)
        ...
        outputChatBox(exports.pool:getServerSyntax(false, "s").."Seçili aksesuar başarıyla silindi.", player, 255, 255, 255, true)
    end
)
...
addEventHandler("wearable.savePositions", root,
    function(player, data)
        ...
        outputChatBox(exports.pool:getServerSyntax(false, "s").."Aksesuarınızın pozisyonu başarıyla kaydedildi!", player, 255, 255, 255, true)
        loadPlayerWearables(player);
    end
);
