...
function updateCig()
	...
	for thePlayer, theObject in pairs(l_cigar) do
		if (isElement(thePlayer)) then
			...
			local ratio = r/360
		    exports.bone_attach:attachElementToBone(theObject,thePlayer,11,0.03,0.02,0.13,0,180,0)
	...
	for thePlayer, theObject in pairs(r_cigar) do
		if (isElement(thePlayer)) then
			...
			exports.bone_attach:attachElementToBone(theObject,thePlayer,12,0,0.02,0.13,0,180,0)
